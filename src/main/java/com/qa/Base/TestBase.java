...
public class TestBase {
	...
	public TestBase(){
		...
		try {
			 ...
			 file = new FileInputStream("/Users/jaideo/Documents/varsha-workspace/LeadFerretCucumberBDDFrameWorkWithPageObjModel/src/main/java/com/qa/config/config.properties");
